from sqlalchemy import create_engine, Column, Integer, String, DateTime, ForeignKey, Boolean, Text, PrimaryKeyConstraint
...
class SessionAudit(Base):
    ...
    event_type = Column(String(50), nullable=False, default="logout")
    ...
    client_version = Column(String(50), nullable=False)
    agent_info = Column(String(50))
    audit_source = Column(Text, default="cleanup_disconected_service")