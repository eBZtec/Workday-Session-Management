        ...
        try:
            ...
            try:
                ...
                if account:
                    ...
                    not_allowed_user = {"action": "notifity", "hostname": hostname, "user": user, "timezone": timezone, "unrestricted": False, "enable": False, "allowed_schedule": None, "timestamp" : timestamp, "message": "Seu login não está cadastrado no WSM, sua sessão será mantida.", "title": f"Login {user} não encontrado", "options": None }
