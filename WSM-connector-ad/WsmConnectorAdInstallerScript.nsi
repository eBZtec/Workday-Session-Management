!define ServiceName "WsmConnectorAdService"
!define ServiceExeName "WorkdaySessionManagementConnectorAd.exe"
...
Name "Workday Session Management Connector AD"
OutFile "WsmConnectorAdSetup.exe"
